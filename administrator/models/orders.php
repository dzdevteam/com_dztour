 ...
 */
class DztourModelorders extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        //Filtering tourid
        $this->setState('filter.tourid', $app->getUserStateFromRequest($this->context.'.filter.tourid', 'filter_tourid', '', 'string'));
    ...
    if (is_numeric($published)) {
        ...
        if ($filter_tourid) {
            $query->where("a.tourid = '".$db->escape($filter_tourid)."'");
        }
    ...
    public function getItems() {
        ...
        foreach ($items as $oneItem) {
            ...
            if (isset($oneItem->tourid)) {
                $values = explode(',', $oneItem->tourid);
            ...
            $oneItem->tourid = !empty($textValue) ? implode(', ', $textValue) : $oneItem->tourid;
