...
class DztourViewTour extends JViewLegacy
{
    ...
    protected function addToolbar()
    {
        ...
        $canDo      = DztourHelper::getActions();

        JToolBarHelper::title(JText::_('COM_DZTOUR_TITLE_TOUR'), 'tour.png');
        ...
        if (!$isNew && $canDo->get('core.create')) {
            JToolBarHelper::custom('tour.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
        }
