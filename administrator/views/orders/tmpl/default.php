...
$canOrder   = $user->authorise('core.edit.state', 'com_dztour');
$saveOrder  = $listOrder == 'a.ordering';
if ($saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_dztour&task=orders.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_dztour&view=orders'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
        ...
        <table class="table table-striped" id="orderList">
            <thead>
                ...
                <th class='left'>
                <?php echo JHtml::_('grid.sort',  'COM_DZTOUR_ORDERS_TOURID', 'a.tourid', $listDirn, $listOrder); ?>
                </th>
                <th class='left'>
                ...
                <th class='left'>
                <?php echo JHtml::_('grid.sort',  'COM_DZTOUR_ORDERS_COMMENT', 'a.comment', $listDirn, $listOrder); ?>
                </th>
            ...
            <?php foreach ($this->items as $i => $item) :
                ...
                $canCreate  = $user->authorise('core.create',       'com_dztour');
                $canEdit    = $user->authorise('core.edit',         'com_dztour');
                $canCheckin = $user->authorise('core.manage',       'com_dztour');
                $canChange  = $user->authorise('core.edit.state',   'com_dztour');
                ?>
                ...
                <?php endif; ?>
                <?php if ($canEdit) : ?>
                    <a href="<?php echo JRoute::_('index.php?option=com_dztour&task=order.edit&id='.(int) $item->id); ?>">
