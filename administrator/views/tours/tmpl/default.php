...
if ($saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_dztour&task=tours.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_dztour&view=tours'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
        ...
        <table class="table table-striped" id="tourList">
            ...
            <?php foreach ($this->items as $i => $item) :
                ...
                <?php endif; ?>
                <?php if ($canEdit) : ?>
                    <a href="<?php echo JRoute::_('index.php?option=com_dztour&task=tour.edit&id='.(int) $item->id); ?>">
